...
// PluginV1Beta1CommitServiceClientProvider provides CommitServiceClients for plugins.
type PluginV1Beta1CommitServiceClientProvider interface {
	PluginV1Beta1CommitServiceClient(registry string) pluginv1beta1connect.CommitServiceClient
}
...
// PluginV1Beta1LabelServiceClientProvider provides LabelServiceClients for plugins.
type PluginV1Beta1LabelServiceClientProvider interface {
	PluginV1Beta1LabelServiceClient(registry string) pluginv1beta1connect.LabelServiceClient
}
...
type ClientProvider interface {
	...
	PluginV1Beta1CommitServiceClientProvider
	PluginV1Beta1DownloadServiceClientProvider
	PluginV1Beta1LabelServiceClientProvider
...
func (c *clientProvider) PluginV1Beta1CommitServiceClient(registry string) pluginv1beta1connect.CommitServiceClient {
	return connectclient.Make(
		c.clientConfig,
		registry,
...
func (c *clientProvider) PluginV1Beta1LabelServiceClient(registry string) pluginv1beta1connect.LabelServiceClient {
	return connectclient.Make(
		c.clientConfig,
		registry,
...
func (nopClientProvider) PluginV1Beta1CommitServiceClient(registry string) pluginv1beta1connect.CommitServiceClient {
...
func (nopClientProvider) PluginV1Beta1LabelServiceClient(registry string) pluginv1beta1connect.LabelServiceClient {
