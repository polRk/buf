...
func typeFlagToPluginType(pluginType string) (pluginv1beta1.PluginType, error) {
	switch pluginType {
	case pluginTypeProtocCodeGeneration:
		return pluginv1beta1.PluginType_PLUGIN_TYPE_PROTOC_CODE_GENERATION, nil
	case pluginTypeCodeGeneration:
		return pluginv1beta1.PluginType_PLUGIN_TYPE_CODE_GENERATION, nil
